...
- 12:00-13:00 — Lunch/break window. Light or no tasks
...
- 17:00+ — Wind-down. Best for planning, reflection, light preparation

### Task-type heuristics (override defaults based on task content):
- "lunch", "eat", "break", "lunch break" → schedule around 12:00-13:00
- "gym", "workout", "exercise", "run", "walk", "yoga", "fitness" → morning before work or late afternoon
