...
const companies = [
  ...
  { name: "Notion", color: "#fff", soft: "rgba(17,24,39,0.08)", border: "rgba(17,24,39,0.18)", svg: <><rect rx="3" fill="#fff" /><rect x="3" y="3" width="18" height="18" rx="3" fill="#0b1220" /><path d="M7 7h10v2H7V7zm0 4h10v2H7v-2zm0 4h6v2H7v-2z" fill="#fff" /></> },
  ...
  { name: "Vercel", color: "#fff", soft: "rgba(17,24,39,0.08)", border: "rgba(17,24,39,0.18)", svg: <><rect fill="#fff" /><path d="M12 3L3 21h18L12 3z" fill="#0b1220" /></> },
  ...
  { name: "Cal.com", color: "#fff", soft: "rgba(17,24,39,0.08)", border: "rgba(17,24,39,0.18)", svg: <><rect rx="4" fill="#fff" /><rect x="4" y="4" width="16" height="16" rx="3" fill="#292929" /><path d="M7 4v3M17 4v3M4 10h16" stroke="#fff" strokeWidth="1.2" /></> },
];
